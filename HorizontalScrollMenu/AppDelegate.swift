...
//
//  Created by Alp Keser on 11/27/16.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let menuVC = HorizontalScrollMenuVC(nibName: "HorizontalScrollMenuVC", bundle: Bundle.main)
        ...
        menuVC.viewControllers = [vc1, vc2, vc3]
        menuVC.titles = ["First VC", "Second VC", "Third VC"]
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "HorizontalScrollMenu")
